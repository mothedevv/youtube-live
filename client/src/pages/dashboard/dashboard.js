...
class Dashboard extends Component 
{
    ...
    checkTabs=()=>
    {
        const panes = document.getElementById("pane");
        const testClass = panes.className;
                        ...
                        <section className="hero is-info">
                            ...
                            <div className="tab-content">
                                <div className="tab-pane" id="pane-1">
                                    <figure>
                                        <img src="https://source.unsplash.com/0_xMuEbpFAQ/400x400" alt="💯" className="cent"/>
                                    </figure>
                                    <figure>
                                        <img src="https://source.unsplash.com/wPMvPMD9KBI/800x600" alt="💯" className="cent"/>
                                    </figure>
                                </div>
                                    ...
                                    <div className="columns is-centered">
                                        <div className="column is-three-quarters">
                                            <div className="embed-container image">
                                                <iframe title="this" src="https://player.vimeo.com/video/261794608" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
                                            </div>
                                        </div>
                                    </div>
                                </div>
